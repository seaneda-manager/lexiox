...
export default function Reading2026Home() {
  return (
    <div className="mx-auto max-w-4xl space-y-6 p-6">
      ...
      {/* 고득점 10계명 - 캐러셀 */}
      <TipsCarousel
        title="Reading 고득점 10계명"
        emoji="🏆"
        color="blue"
        tips={[
          "Complete the Words는 앞뒤 문맥과 철자 단서를 매핑하라. 문법(명사/동사/형용사)을 확인하고 문맥으로 정확한 스펠링을 매칭하세요.",
          "Read in Daily Life는 지엽적 집착을 버리고 빠르게 파싱하라. '누가, 왜, 무엇을 요구하는가?' 핵심 용건만 슥 훑고 1지문당 2~3개 문제를 광속으로 풀어 시간을 아끼세요.",
          "Read an Academic Passage는 길이가 200단어로 반토막 났음을 기억하라. 700단어 압박감을 버리고 한 문장 한 문장의 의미 구조를 정확하게 해석하세요.",
          "비순차적 문제 출제(Non-sequential Order)에 당황하지 마라. 문제를 먼저 읽고 키워드가 지문의 어느 포인트를 가리키는지 빠르게 역추적하는 스캐닝 능력을 기르세요.",
          "지문 단어와 선택지 단어의 소리 일치 함정을 소거하라. 어휘 겹침 트랩이 아닌지 문장의 전체적인 로직과 의미가 일치하는지 끝까지 서술어를 대조하세요.",
          "과장된 한정사(All, Only, Every, Never)가 섞인 보기는 거르고 보라. 극단적인 100% 확정형 단어는 오답 필터링 1순위입니다.",
          "역접과 인과의 연결어(However, Therefore) 뒷문장은 무조건 정답 단서다. However, In fact, Therefore, Consequently 뒷문장은 정답 코드로 직결되니 속도를 늦추고 정독하세요.",
          "Paraphrasing(말 바꾸기)된 선택지가 진짜 정답 노드다. 단어는 완전히 달라졌지만 뜻이 100% 똑같은 초이스를 찾아내는 숨은그림찾기입니다.",
          "모르는 전문 용어가 나와도 정의(Definition) 힌트를 활용해 넘어가라. 어려운 용어 뒤에는 대시(—), 콤마, which is defined as 등으로 쉬운 단어로 뜻을 풀어서 설명해 줍니다.",
          "적응형 시험이니 Module 1에서 모든 에너지를 쏟아부어라. Module 1 성적이 나쁘면 뒤에서 만점을 받아도 고득점 진입이 원천 차단되므로 초집중으로 디버깅하세요.",
        ]}
      />
    </div>
  );
