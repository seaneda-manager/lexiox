...
DROP POLICY IF EXISTS "authenticated_read" ON public.answer_key;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.listening_passages;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.listening_questions;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.listening_choices;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.listening_answers;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.naesin_reading_passages;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.naesin_reading_questions;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.naesin_reading_choices;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.naesin_reading_answers;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.hi_naesin_passages;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.hi_naesin_variant_questions;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.hi_naesin_variant_choices;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.hi_naesin_variant_answers;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.grammar_units;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.grammar_chapters;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.grammar_2026_units;
CREATE POLICY "authenticated_read" ON public.grammar_2026_units FOR SELECT TO authenticated USING (true);

-- Lectures
ALTER TABLE public.lectures ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "authenticated_read" ON public.lectures;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.lecture_questions;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.lecture_quiz_questions;
...
DROP POLICY IF EXISTS "authenticated_read" ON public.digital_writing_items;
