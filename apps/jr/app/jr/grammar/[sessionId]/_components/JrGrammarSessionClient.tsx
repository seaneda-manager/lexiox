  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="mx-auto max-w-4xl">
        <h1 className="text-3xl font-bold mb-4">🔤 Grammar Session</h1>
        <div className="bg-white rounded-lg p-6 shadow">
          ...
          <div className="mt-4 p-4 bg-slate-50 rounded">
            <h2 className="font-semibold mb-2">Chapter: {chapter.title}</h2>
            <p className="text-slate-700">{chapter.content || "No content"}</p>
          </div>
        </div>
      </div>
    </div>
